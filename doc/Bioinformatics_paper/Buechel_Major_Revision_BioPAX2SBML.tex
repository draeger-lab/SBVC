...
BioPAX can be used to describe the biological \NEW{semantics} of metabolic, signaling, molecular, gene-regulatory and genetic interaction networks \NEW{and is mainly used for information exchange} \citep{Demir2010}.
SBML describes the structure of models, and offers the possibility to include mathematical expressions \NEW{which are necessary for simulation purposes} \citep{Hucka2003}.
\NEW{A detailed comparison between both languages can be found in \citet{Stromback2005} and \citet{Stromback2006}.}
