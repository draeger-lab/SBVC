...
Before the creation of \qual{}, relations could not be translated into SBML at all or were erroneously converted to reactions.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%% BEGIN FIGURE 2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[t!h]
\centering \includegraphics[width=0.8\columnwidth]{Buechel_Figure2_CeramidePart.png}
...
Only BioPAX2SBML converter uses the \qual{} extension and SBO terms for detailed species description, translates the BioPAX cross-references (\texttt{Xrefs}) into SBML CV terms, and augments the SMBL file content with further database cross-references.
