...
~~Machine interpretable & \checkmark & \checkmark & $\circ$ & $\circ$ & \checkmark & \checkmark \\
~~Human interpretable & \checkmark & \checkmark & \checkmark & \checkmark & $\times$ & $\times$ \\
...
~~Revision of reactions & \checkmark & \checkmark & $\times$ & \checkmark & $\times$ & $\times$ \\
~~Stoichiometry & \checkmark & $\times$ & $\times$ & $\times$ & $\times$ & $\times$ \\

\multicolumn{7}{l}{\textbf{SBML}} \\
~~Valid & \checkmark & \checkmark & $\times$ & \checkmark & n/a & \checkmark \\
~~Level.Version & 2.4, 3.1 & 2.4 & 2.1 & 1.1 up to 2.3 & n/a & 2.4 \\
~~SBO terms & \checkmark & \checkmark & $\times$ & $\times$ & n/a & $\times$ \\
~~Notes & \checkmark & \checkmark & $\times$ & $\times$ & n/a & $\times$ \\
~~Annotations & \checkmark & \checkmark & $\times$ & $\times$ & n/a & $\times$ \\
...
~~Notes & \checkmark & n/a & n/a & n/a & $\times$ & $\times$ \\
~~Annotations & \checkmark & n/a & n/a & n/a & \checkmark & $\times$ \\
...
This table compares various applications that can convert KEGG pathways to BioPAX or SBML models. A checkmark (\checkmark) is given, if the
