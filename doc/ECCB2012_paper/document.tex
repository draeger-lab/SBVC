...
Unfortunately, prior to the release of the SBML Qualitative Models (\qual) extension, it was not possible to properly describe relations in SBML.
...
Since, older simulation applications still work with older BioPax levels, we also translated the BioPax Level~2 files into SBML to prevent lost of information and to be able to use older BioPax models, too. 
