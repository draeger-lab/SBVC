 ...
 * @version $Rev$
 */
public class BioPAXImporter extends NotifyingWorker<Object, Void> {
...
//      KGMLWriter.writeKGML(keggPathway, false); // Can be used for debugging
      ...
      fireActionEvent(new ActionEvent(this, 11, name));
      // Recommended ToolTip for this tab
      fireActionEvent(new ActionEvent(this, 12, String.format("BioPAX pathway '%s' from file '%s'.", pwName, biopaxFile.getName())));
      // The species
      if (spec!=null) {
