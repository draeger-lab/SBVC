/*
 * $Id: BioPAXL32KGML.java 180 2014-01-09 22:21:09Z draeger $
 * $URL: https://rarepos.cs.uni-tuebingen.de/svn-path/SBVC/trunk/src/de/zbit/biopax/BioPAXL32KGML.java $
 * ---------------------------------------------------------------------
...
//        }
  ...
  private EntryExtended createKEGGEntry(Entity entity, de.zbit.kegg.parser.pathway.Pathway keggPW,
    ...
    if (entity!=null){
      // get all available database identifiers of the entity
  ...
  private Reaction createKEGGReaction(Set<PhysicalEntity> lefts, Set<PhysicalEntity> rights,
    ...
    for (PhysicalEntity right : rights) {
      ...
      if (keggEntry != null) {
        ...
        for (Stoichiometry stoichi : stoichiometry) {
          if (stoichi.getPhysicalEntity() == null)
            continue;
